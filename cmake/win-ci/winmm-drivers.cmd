...
set FILES_LIST=opnmidiconfigtool.exe opnmididrv.dll libopnconfig.cpl drvsetup.exe drvtest.exe install.bat uninstall.bat
...
cd build-drv-prexp
7z a -t7z -mx9 "libOPNMIDI-winmm-driver-prexp.7z" %FILES_LIST%
if %errorlevel% neq 0 exit /b %errorlevel%
appveyor PushArtifact "libOPNMIDI-winmm-driver-prexp.7z"
if %errorlevel% neq 0 exit /b %errorlevel%
cd ..
...
cd build-drv-32
7z a -t7z -mx9 "libOPNMIDI-winmm-driver-x86.7z" %FILES_LIST%
if %errorlevel% neq 0 exit /b %errorlevel%
appveyor PushArtifact "libOPNMIDI-winmm-driver-x86.7z"
if %errorlevel% neq 0 exit /b %errorlevel%
for %%f in (%FILES_LIST%) DO copy %%f ..\x86
cd ..

cd build-drv-64
7z a -t7z -mx9 "libOPNMIDI-winmm-driver-x64.7z" %FILES_LIST%
if %errorlevel% neq 0 exit /b %errorlevel%
appveyor PushArtifact "libOPNMIDI-winmm-driver-x64.7z"
if %errorlevel% neq 0 exit /b %errorlevel%
...
7z a -t7z -mx9 "libOPNMIDI-winmm-driver-all.7z" *install*.bat x86 x64
if %errorlevel% neq 0 exit /b %errorlevel%
appveyor PushArtifact "libOPNMIDI-winmm-driver-all.7z"
if %errorlevel% neq 0 exit /b %errorlevel%
