...
#ifndef YM2608LLE_OPN2_H
#define YM2608LLE_OPN2_H

#include "opn_chip_base.h"

class Ym2608LLEOPNA final : public OPNChipBaseT<Ym2608LLEOPNA>
{
    void *m_chip;
public:
    Ym2608LLEOPNA(OPNFamily f);
    ~Ym2608LLEOPNA() override;
