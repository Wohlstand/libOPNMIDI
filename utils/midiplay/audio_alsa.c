...
{
    if(prev_format == OPNMIDI_SampleType_F64)
        return OPNMIDI_SampleType_F32;
    else if(prev_format == OPNMIDI_SampleType_F32)
        return OPNMIDI_SampleType_S32;
    else if(prev_format == OPNMIDI_SampleType_U32)
        return OPNMIDI_SampleType_S32;
    else if(prev_format == OPNMIDI_SampleType_S32)
        return OPNMIDI_SampleType_S24;
    else if(prev_format == OPNMIDI_SampleType_U24)
        return OPNMIDI_SampleType_S24;
    else if(prev_format == OPNMIDI_SampleType_S24)
        return OPNMIDI_SampleType_S16;
    else if(prev_format == OPNMIDI_SampleType_U16)
        return OPNMIDI_SampleType_S16;
    else if(prev_format == OPNMIDI_SampleType_S16)
        return OPNMIDI_SampleType_U8;
    else if(prev_format == OPNMIDI_SampleType_S8)
        return OPNMIDI_SampleType_U8;
